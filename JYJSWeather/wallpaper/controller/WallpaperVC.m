...
- (void)creatWallpaper
{
    ...
    CGFloat height = narrowImage_height/narrowImage_width * width;
...
//    cell.wallpaper.image = [UIImage imageNamed:@"little_1.png"];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [singlePaper.wallpaper setImageWithURL:url placeholderImage:nil];
